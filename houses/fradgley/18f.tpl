...
<p>Welcome to the Burchill Homepage. Here is a list of all of our students</p>

<div>
    <table style="background-color:transparent;" class="table table-hover table-bordered table-sm table-dark">
    <thead style="background-color:#7C51A1;">
        <tr>
...
%for event in events:  
        <tr>
            <form action='/houses/burchill/18f/submit' method='post'>
            <input type="hidden" name="EventID" value="{{event[0]}}">
                ...
                <td>
                    <div class="dropdown">
                        <select name="StudentID" id="StudentID" class="btn btn-FG dropdown-toggle">
