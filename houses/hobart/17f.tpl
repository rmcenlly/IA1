...
<p>Welcome to the Hobart Homepage. Here is a list of all of our students</p>

<div>
    <table style="background-color:transparent;" class="table table-hover table-bordered table-sm table-dark">
    <thead style="background-color:#FFCB08;">
        <tr>
...
%for event in events:  
        <tr>
            <form action='/houses/hobart/17f/submit' method='post'>
            <input type="hidden" name="EventID" value="{{event[0]}}">
                ...
                <td>
                    <div class="dropdown">
                        <select name="StudentID" id="StudentID" class="btn btn-HT dropdown-toggle">
