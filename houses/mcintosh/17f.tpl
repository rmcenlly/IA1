...
<p>Welcome to the McIntosh Homepage. Here is a list of all of our students</p>

<div>
    <table style="background-color:transparent;" class="table table-hover table-bordered table-sm table-dark">
    <thead style="background-color:#004A8F;">
        <tr>
...
%for event in events:  
        <tr>
            <form action='/houses/mcintosh/17f/submit' method='post'>
            <input type="hidden" name="EventID" value="{{event[0]}}">
                ...
                <td>
                    <div class="dropdown">
                        <select name="StudentID" id="StudentID" class="btn btn-MC dropdown-toggle">
